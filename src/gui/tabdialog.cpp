    ...
    : QDialog(parent)
{
    ...
    tabWidget->addTab(new GeneralTab(fileInfo), tr("Player"));
    tabWidget->addTab(new PermissionsTab(fileInfo), tr("Detector"));
    tabWidget->addTab(new ApplicationsTab(fileInfo), tr("Tracker"));
//! [0]
